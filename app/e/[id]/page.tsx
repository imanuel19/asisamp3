              ...
              <div className="download-section">
                ...
                <div className="download-buttons">
                  {["128kbps", "320kbps"].map((quality) => (
                    <a
                      key={quality}
                      href={`https://lil.sounddownmp3.com/api/download?id=${song.id}&quality=${quality}&type=audio`}
              ...
              <div className="download-section">
                ...
                <div className="download-buttons">
                  {["360p", "720p"].map((quality) => (
                    <a
                      key={quality}
                      href={`https://lil.sounddownmp3.com/api/download?id=${song.id}&quality=${quality}&type=video`}
